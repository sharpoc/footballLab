...
- 至少注册一个赔率备源 key：The Odds API / odds-api.io / OddsPapi。
- 继续执行 `docs/superpowers/plans/2026-06-08-plan0-data-source-probe.md` 的赔率备源探测。
- 补齐 `docs/superpowers/data-contract.md` 中的赔率字段契约。
