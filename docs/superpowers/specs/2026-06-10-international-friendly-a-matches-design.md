...
- 日期：2026-06-10
- 状态：Backlog / Paused，世界杯开赛前暂停，先优化国家队世界杯算法
- 范围：最近 7 天滚动窗口内的成年男子国家队国际 A 级赛事，本地 snapshot 与预览页接入
- 已选方案：B，探测成功后接入本地 snapshot 和预览页，不接入线上 scheduled publish

## 当前优先级

本功能已记为代办。由于 2026 世界杯将在北京时间 2026-06-11 开赛，当前开发优先级切换为国家队世界杯算法优化与赛前验证。

恢复本功能的建议时机：

1. 世界杯开赛初期核心国家队算法和数据刷新稳定后。
2. 世界杯阶段性结束或赛事间歇期。
3. 世界杯结束后启动俱乐部赛事设计前，先复核国际 A 级赛事数据源是否仍值得接入。
